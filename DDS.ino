...
ISR(TIMER1_COMPA_vect){
  if (on == 1){
    ...
    switch (shape) {
      ...
      case 3://sinus
        sinNum = t*sinInc;
        wave = pgm_read_byte_near(sine + sinNum);
      break;
      case 4://prostokat
        if((period-t) > t) {
          if (t == 0){
...
void displey(){
    ...
    switch(shape){
      ...
      break;
      case 1:
        display.println("Trojkat:");
      break;
      case 2:
        display.println("Pila:");
      break;
      case 3:
        display.println("Sinus:");
      break;
      case 4:
        display.println("Prostokat:");
      break;
    }
...
void loop() {
  ...
  if(digitalRead(A1)== LOW){
    delay(200);
    if( on == 0){
      frequency = x1*10000+x2*1000+x3*100+x4*10+x5;
